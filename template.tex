...
\title{On the treatment of discordant data in detrital zircon U--Pb
  geochronology}
...
\begin{abstract}
  ...
  provenance analysis and crustal evolution studies. Calculating
  ...
  the best results, in the sense that it yields age spectra that are
  identical for the \textsuperscript{206}Pb/\textsuperscript{238}U and
  \textsuperscript{207}Pb/\textsuperscript{206}Pb clocks.  All the
  methods presented in this paper have been implemented in the
  \texttt{IsoplotR} geochronology toolbox.
\end{abstract}
...
\codedataavailability{\texttt{IsoplotR} is free software released under the GPL-3 license. The package and its source code are availablef from
  \texttt{https://cran.r-project.org/package=IsoplotR}. The test data can be
downloaded from the supplementary information.} %% use this section when having data sets and software code available
